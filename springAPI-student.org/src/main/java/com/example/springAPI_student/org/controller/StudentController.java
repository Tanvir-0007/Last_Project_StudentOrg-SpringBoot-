...
public class StudentController {
  ...
  public Page<Student> searchStudents(@RequestParam(required = false) String name,
                                      ...
                                      @RequestParam int size) {
    Pageable pageable = PageRequest.of(page, size);
    Page<Student> result = studentService.searchStudents(name, id, pageable);

    // Log the parameters and results for debugging
    System.out.println("Search Params - Name: " + name + ", ID: " + id + ", Page: " + page + ", Size: " + size);
    System.out.println("Search Results - Total Elements: " + result.getTotalElements());
